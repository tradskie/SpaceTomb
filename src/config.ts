...
import {Configuration} from './space-finance/config';
import {BankInfo} from './space-finance';
...
const configurations: {[env: string]: Configuration} = {
  ...
  //     'SPACE-BTCB-LP': ['0x2A651563C9d3Af67aE0388a5c8F89b867038089e', 18],
  ...
  development: {
    ...
    deployments: require('./space-finance/deployments/deployments.mainnet.json'),
    externalTokens: {
      WBNB: ['0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18],
      ...
      'SPACE-BTCB-LP': ['0x84392649eb0bC1c1532F2180E58Bae4E1dAbd8D6', 18],
      'SPACE-BNB-LP': ['0x107CDC0c46615C63EE4abC4E1e264D3BD12390e6', 18],
      'SHARE-BNB-LP': ['0x1303246855b5B5EbC71F049Fdb607494e97218f8', 18],
      'SSHARE-BNB-APELP': ['0x0dE2a71b2f43CF588A00422d41E1C02D0E08D552', 18],
      'SPACE-BTCB-APELP': ['0xB6E85031F313563bF12ea414118978C8BD78db5D', 18],
    },
  ...
  production: {
    ...
    externalTokens: {
      ...
      'SPACE-BTCB-LP': ['0x84392649eb0bC1c1532F2180E58Bae4E1dAbd8D6', 18],
      'SPACE-BNB-LP': ['0x107CDC0c46615C63EE4abC4E1e264D3BD12390e6', 18],
      'SSHARE-BNB-LP': ['0x1303246855b5B5EbC71F049Fdb607494e97218f8', 18],
      'SSHARE-BNB-APELP': ['0x0dE2a71b2f43CF588A00422d41E1C02D0E08D552', 18],
      'SPACE-BTCB-APELP': ['0xB6E85031F313563bF12ea414118978C8BD78db5D', 18],
    },
    baseLaunchDate: new Date('2021-11-20 1:00:00Z'),
...
export const bankDefinitions: {[contractName: string]: BankInfo} = {
  ...
  sectionInUI: way to distinguish in which of the 3 pool groups it should be listed
        ...
        - 1 = LP asset staking rewarding SPACE
  ...
  */
  ...
  // },
   SpaceCakeRewardPool: {
     name: 'Earn SPACE by CAKE',
     poolId: 0,
     sectionInUI: 0,
     contract: 'SpaceCAKERewardPool',
  ...
  SpaceSBTCRewardPool: {
    name: 'Earn SPACE by SBTC',
    poolId: 2,
    sectionInUI: 0,
    contract: 'SpaceSBTCRewardPool',
...
//  SpaceSUSDRewardPool: {
//    name: 'Earn SPACE by SUSD',
//    poolId: 1,
//    sectionInUI: 0,
//    contract: 'SpaceSUSDRewardPool',
...
//  },
  ...
  // },
   ...
   SpaceWBNBGenesisRewardPool: {
     name: 'Earn SPACE by WBNB',
     poolId: 4,
     sectionInUI: 0,
     contract: 'SpaceWBNBGenesisRewardPool',
  ...
  // SpaceBnbLPRewardPool: {
  //   name: 'Earn SPACE by BOMB-BNB LP',
  //   poolId: 1,
  //   sectionInUI: 0,
  //   contract: 'SpaceBnbLPRewardPool',
  //   depositTokenName: 'SPACE-BNB-LP',
  //   earnTokenName: 'SPACE',
  //   finished: false,
  //   sort: 8,
  //   closedForStaking: false,
  ...
  //   closedForStaking: false,
  // },
//  SshareBnbApeLPSShareRewardPool: {
//    name: 'Earn SSHARE by SSHARE-BNB Ape LP',
//    poolId: 2,
//    sectionInUI: 1,
//    contract: 'SshareBnbApeLPSShareRewardPool',
//    depositTokenName: 'SSHARE-BNB-APELP',
//    earnTokenName: 'SSHARE',
//    finished: true,
//    sort: 5,
//    closedForStaking: true,
//  },
  // SpaceBtcbApeLPBShareRewardPool: {
  //   name: 'Earn BSHARE by SPACE-BTCB Ape LP',
  //   poolId: 3,
  //   sectionInUI: 2,
  //   contract: 'SpaceBtcbApeLPBShareRewardPool',
  //   depositTokenName: 'SPACE-BTCB-APELP',
  //   earnTokenName: 'BSHARE',
  //   finished: true,
  //   sort: 4,
  //   closedForStaking: true,
  // },
//  SshareBnbLPSShareRewardPool: {
//    name: 'Earn SSHARE by SSHARE-BNB LP',
//    poolId: 0,
//    sectionInUI: 2,
//    contract: 'SshareBnbLPSShareRewardPool',
//    depositTokenName: 'SSHARE-BNB-LP',
//    earnTokenName: 'SSHARE',
//    finished: false,
//    sort: 2,
//    closedForStaking: false,
//  },
//  SpaceBtcbLPSShareRewardPool: {
//    name: 'Earn SSHARE by SPACE-BTCB LP',
//    poolId: 1,
//    sectionInUI: 2,
//    contract: 'SpaceBtcbLPSShareRewardPool',
//    depositTokenName: 'SPACE-BTCB-LP',
//    earnTokenName: 'SSHARE',
//    finished: false,
//    sort: 1,
//    closedForStaking: false,
