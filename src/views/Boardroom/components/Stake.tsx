...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(spaceFinance.SSHARE, spaceFinance.contracts.Boardroom.address);

  const tokenBalance = useTokenBalance(spaceFinance.SSHARE);
  const stakedBalance = useStakedBalanceOnBoardroom();
  const {from, to} = useUnstakeTimerBoardroom();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('SSHARE', spaceFinance.SSHARE);
        ...
        <CardContent>
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'SSHARE Staked'} variant="yellow" />
            </StyledCardHeader>
            <StyledCardActions>
